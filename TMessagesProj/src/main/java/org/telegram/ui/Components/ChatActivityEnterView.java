...
//                    list.add(2);
    ...
    public ChatActivityEnterView(Activity context, SizeNotifierFrameLayout parent, ChatActivity fragment, final boolean isChat, Theme.ResourcesProvider resourcesProvider) {
        ...
        yasuFeaturesButton.setMinimumHeight(0);
...
//        }
    ...
    // YASU_FEATURES_PANEL
    // لوحة الميزات — أزرار مباشرة وسريعة مع تأثير لمس.
    private void showYasuFeaturesPanel() {
        if (getContext() == null) {
            return;
        }
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            Runnable updateToggle = () -> {
                ...
                switch (index) {
                    case 0:
                        enabled = yasuFeature000;
                        break;
                    case 1:
                        enabled = yasuFeature001;
                        break;
                    case 2:
                        enabled = yasuFeature002;
                        break;
                    case 3:
                        enabled = yasuFeature003;
                        break;
                    default:
                        enabled = yasuFeature004;
                        break;
                }
            ...
            toggle.setOnClickListener(v -> {
                ...
                switch (index) {
                    case 0:
                        currentlyEnabled = yasuFeature000;
                        break;
                    case 1:
                        currentlyEnabled = yasuFeature001;
                        break;
                    case 2:
                        currentlyEnabled = yasuFeature002;
                        break;
                    case 3:
                        currentlyEnabled = yasuFeature003;
                        break;
                    default:
                        currentlyEnabled = yasuFeature004;
                        break;
                }
